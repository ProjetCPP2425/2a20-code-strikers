...
struct qt_meta_stringdata_CLASSpieChartENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSpieChartENDCLASS = QtMocHelpers::stringData(
    "pieChart"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSpieChartENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject pieChart::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSpieChartENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSpieChartENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSpieChartENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *pieChart::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSpieChartENDCLASS.stringdata0))
